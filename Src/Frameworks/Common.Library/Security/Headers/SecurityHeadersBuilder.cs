using Common.Lib.Security.Constants;
...
public class SecurityHeadersBuilder
{
    ...
    ///     Enables XSS protections and instructs the user-agent to block the response in the event that script has been
    ...
    ///     A partially supported directive that tells the user-agent to report potential XSS attacks to a single URL. Data
    ///     will be POST'd to the report URL in JSON format.
    /// </summary>
